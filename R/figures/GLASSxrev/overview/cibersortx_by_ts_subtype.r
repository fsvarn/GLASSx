###################################################
# Compare CIBERSORTx profiles across glioma transcriptional subtypes 
# Analyzed for the whole dataset and split across initial/recurrent tumors
# Author: Frederick Varn
# Date: 2021.12.29
# Figure 1C- transcriptional subtypes, Figure S1D
##################################################
...
pdf("/projects/verhaak-lab/GLASS-III/figures/analysis/cibersortx_stacked_barplot_ts_subtype_split.pdf",width=1.565,height=2.033)
ggplot(ts_fract_split, aes(fill=cell_state, y=fraction, x=subtype)) + 
geom_bar(position="stack", stat="identity") +
scale_fill_manual(values=c("B cell" = "#eff3ff", "Granulocyte" = "#bdd7e7", "T cell" = "#6baed6", "Dendritic cell" = "#3182bd", "Myeloid" = "#08519c",
						 "Oligodendrocyte" = "#2ca25f",
						 "Endothelial" = "#ffffd4", "Pericyte" = "#fee391",
