...
# Date: 2021.12.29
# Figure S1G- transcriptional subtypes
##################################################
...
pdf("/projects/verhaak-lab/GLASS-III/figures/analysis/cibersortx_stacked_barplot_ts_subtype_neftel.pdf",width=1,height=1.82)
