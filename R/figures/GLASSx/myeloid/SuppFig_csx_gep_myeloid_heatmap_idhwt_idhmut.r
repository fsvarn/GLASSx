...
expr[which(expr > 0.19)] <- 0.19 # Plug the number in from the whole dataset (obtained below) back in for scaling
...
aesthetics = "fill", limits = c(-0.19, 0.19)) + 
theme_void() +
...
quantile(plot_res$expr,.99) #0.19
