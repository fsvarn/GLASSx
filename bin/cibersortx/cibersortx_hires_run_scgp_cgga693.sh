...
-B /projects/verhaak-lab/GLASS-III/results/cibersortx/hires/cgga_scgp/:/src/outdir \
...
--mixture CGGA.mRNAseq_693.RSEM-genes.20200506.txt \
--sigmatrix scgp_sig.txt \
--label 'cgga' \
--rmbatchSmode TRUE \
--refsample 10x_scgp_cibersortx_ref_06092020.txt \
--subsetgenes cgga_common_genes.txt \
--threads 12 \
--cluster  true
