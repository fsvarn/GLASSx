...
singularity exec \
-B /projects/verhaak-lab/GLASS-III/data/subset/cibersortx_hires_tcga/:/src/data \
-B /projects/verhaak-lab/GLASS-III/results/cibersortx/hires/tcga-v2/:/src/outdir \
...
--mixture TCGA_Firehose_RNASeqV2_LGGGBM_for_CIBERSORTx.txt \
--sigmatrix scgp_sig.txt \
--classes cell_subsets.txt \
--label 'TCGA' \
--rmbatchSmode TRUE \
