...
mes_sig <- rownames(tcga_dat %>% filter(q.val < 0.05 & eff > log2(1.1)))
...
pdf("/projects/verhaak-lab/GLASS-III/figures/analysis/toil_ivygap_mdm_mg_mes_cor_bar.pdf",width=3,height=3)  
