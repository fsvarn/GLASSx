...
myinf1 <- myinf1[-grep("GLSS-HF-2|GLSS-HF-3",myinf1)] #Remove previous HF samples
myoutf1 <- myinf1
myoutf1 <- gsub(".tsv","",myoutf1)
myinf1 <- paste(myDir1,myinf1,sep="")

myTarDir <-"/projects/varnf/TEMP/101320_new_info_GLSS-H2/"
...
myTarDir <-"/projects/varnf/TEMP/101320_new_geno_GLSS-H2/"
myoutf1 <- paste(myTarDir, myoutf1,".sp",sep="")
