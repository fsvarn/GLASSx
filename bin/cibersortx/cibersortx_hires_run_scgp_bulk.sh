...
singularity exec \
-B /projects/verhaak-lab/GLASS-III/data/cibersortx/scgp_bulk/:/src/data \
-B /projects/verhaak-lab/GLASS-III/results/cibersortx/hires/scgp_bulk/:/src/outdir \
...
--classes scgp_subset.txt \
--subsetgenes scgp_common_genes.txt \
--threads 12 \
--cluster  true
