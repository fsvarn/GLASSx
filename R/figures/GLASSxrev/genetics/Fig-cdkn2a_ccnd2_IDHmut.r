###################################################
# Compare CIBERSORTx profiles in IDH-mutant samples with acquired cell cycle alterations
...
pdf("/projects/verhaak-lab/GLASS-III/figures/analysis/cell_cycle_idhmut_cell_state_changes_v2.pdf",width=2,height=1.6)
